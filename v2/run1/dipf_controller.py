"""
FULL PURE-DIPF CONTROLLER - YAML CONFIGURATION VERSION (v2)
...
def compute_episode_cost(hist):
    ...
    d = min(min_closest, min_edge, 0.5)
    c_collision = math.exp(1.0 - d / 0.5) / (math.e - 1.0)
...
def run_simulation():
    ...
    print("=" * 90)
    print("FULL PURE-DIPF CONTROLLER (v2 -- unified obstacle potential, hard boundary collision)")
    print("=" * 90)
